...
./ray-tracer --width 1920 --height 1080 --number_of_samples 1000 --output_file_name "./example_images/simple_scene_1920_1080_1000.png" --scene "simple_scene" --show_after_complete 0 --number_of_workers 4 > ./log/simple_scene_1920_1080_100.log
