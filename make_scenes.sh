...
./ray-tracer --width 1920 --height 1080 --number_of_samples 1000 --output_file_name "./example_images/simple_scene_spheres_1920_1080_100.png" --scene "simple_scene_spheres" --show_after_complete 0 --number_of_workers 4 > ./log/simple_scene_spheres_1920_1080_100.log
